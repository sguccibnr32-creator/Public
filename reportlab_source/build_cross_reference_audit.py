...
def sec_numerics(story):
    ...
    story.append(tbl(
        ...
        [
            ...
            ['Lambda_UV(0.83)', '9.549 &#183; 10^(-49) J', 'Chap 18-4 外挿'],
            ...
            ['alpha_PT_upper (V_xi)', '<b>2.96 &#183; 10^(-53)</b>', 'M1'],
            ['tau_m_upper (FIRAS)', '1.418 &#183; 10^53 s', 'V_xi primary'],
            ['NGC 3198 2.32%', 'PASS (k N_mode = 2.998e+38 vs 2.93e+38)', 'M3'],
    ...
    story.append(tbl(
        ...
        [
            ['c_mem(0.83)', '3.833e+05 m/s', '3.833 &#183; 10^5 m/s', '整合'],
