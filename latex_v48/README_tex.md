...
coupling の閉形式導出を 14 頁 (LuaLaTeX 版、A4, 20mm margin) で提示する。
...
6. comment 欄に `v4.7.8 companion paper; 14 pages, 15 references` 等を記載
...
- ページ 8 付近に 3.6pt の軽微な overfull hbox 1 件 (半文字未満、視覚的に問題なし)
